...
/*   Updated: 2023/02/22 20:22:16 by hanmpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/so_long.h"

static void	draw_elements(t_pos win, t_pos pl, t_data *game)
{
...
static void	draw_game(t_data *game)
{
	t_pos	pl;
	int		og;
	t_pos	win;
