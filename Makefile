...
#    Updated: 2023/02/20 13:53:08 by hanmpark         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# SOURCES AND OBJECTS
MAP_SRC = map_init.c map_check.c structs_init.c game_init.c move_player.c check_path.c \
			hooks.c render.c update.c move_enemy.c
